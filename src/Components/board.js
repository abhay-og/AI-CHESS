...
import {clear_highlight} from "./clear_highlight";
import {clear_possible_highlight} from "./clear_possible_highlight";
import {Collected} from "./collected";
import {highlight_mate} from "./highlight_mate";
import {filler_piece} from "./filler_piece";
import {Queen} from "./queen";
import {get_piece_value} from "./get_piece_value";
import {shuffle} from "./shuffle";
import {clear_check_highlight} from "./clear_check_highlight";
import {Label} from "./label";
import {calc_squareColor} from "./calc_squareColor";
            ...
            <div>
                ...
                {black_mated && not_history && (
                    <div>
                        <audio
                            ref="audio_tag"
                            src={require('./sfx/Black_Defeat.mp3')}
                            controls
                            autoPlay
                            hidden
                        />
                ...
                {white_mated && not_history && (
                    <div>
                        <audio
                            ref="audio_tag"
                            src={require('./sfx/White_Defeat.mp3')}
                            controls
                            autoPlay
                            hidden
                        />
                ...
                {this.state.check_flash &&
                    ...
                    !this.state.just_clicked && (
                        <div>
                            ...
                            <audio
                                ref="audio_tag"
                                src={require('./sfx/Check_Flash.mp3')}
                                controls
                                autoPlay
                                hidden
                            />
